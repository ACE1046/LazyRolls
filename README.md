...
10.04.2026 v0.15.5
* Для шаговых двигателей добавлена плавная остановка при движении вниз и удержание в течение ~1 сек после остановки, для предотвращения разматывания шторы по инерции.
