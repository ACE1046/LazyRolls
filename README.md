...
v0.14
* Добавлена поддержка моторов постоянного тока, в том числе с энкодером.
...
* Добавлен gratuitous ARP. Привод постоянно сообщает свой IP в сети. Включается автоматически, если не используется MQTT. Должно исключить случаи недоступности привода в сети.
